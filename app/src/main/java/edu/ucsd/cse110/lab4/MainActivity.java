...
public class MainActivity extends AppCompatActivity {
    ...
    public void onShowCounterClicked(View view) {
        ...
        TextView maxCountView = findViewById(R.id.count_textview);
        String maxCounter = maxCountView.getText().toString();
        Optional<Integer> maybeMaxCount = Utilities.parseCount(maxCounter);
